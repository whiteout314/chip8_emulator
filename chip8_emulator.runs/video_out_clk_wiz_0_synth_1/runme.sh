...
HD_PWD='/home/calma/Workspace/personal/chip8_emulator/chip8_emulator.runs/video_out_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_out_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_out_clk_wiz_0.tcl
